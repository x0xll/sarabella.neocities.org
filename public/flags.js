...
\
    <div class="languages">\
        ...
        <!--<img src="/images/Flags/flag_no.gif" onclick="changeLanguage(\'no\', true)" title="Norge" alt="Norge">-->\
        <!--<img src="/images/Flags/flag_fi.gif" onclick="changeLanguage(\'fi\', true)" title="Suomi" alt="Suomi">-->\
        <!--<img src="/images/Flags/flag_ru.gif" onclick="changeLanguage(\'ru\', true)" title="Россия" alt="Россия">-->\
        <!--<img src="/images/Flags/flag_cl.gif" onclick="changeLanguage(\'es\', true)" title="Chile" alt="Chile">-->\
        <!--<img src="/images/Flags/flag_mx.gif" onclick="changeLanguage(\'es\', true)" title="México" alt="México">-->\
