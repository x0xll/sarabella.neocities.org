...
// Actual game start
class AirFoalStable extends Phaser.Scene
{
    constructor ()
    {
        super({
    ...
    {  
        ...
        this.load.image('stable_bg', './images/airFoalStable/stable-bg.png');
        ...
        this.load.atlas('leaf_tree_shake', './images/airFoalStable/leaf_tree_shake.png', './images/airFoalStable/leaf_tree_shake.json');
        this.load.atlas('leaf_chimes', './images/airFoalStable/leaf_chimes.png', './images/airFoalStable/leaf_chimes.json');
        ...
        this.load.atlas('fountain', './images/airFoalStable/fountain.png', './images/airFoalStable/fountain.json');
        this.load.atlas('food_interactive', './images/airStable/food_interactive.png', './images/airStable/food_interactive.json');
        this.load.atlas('berries', './images/airFoalStable/berries.png','./images/airFoalStable/berries.json');
    ...
    create ()
    {
        ...
        // Brush
        const brush = this.add.sprite(710, 225, 'brush', 'idle').setScale(0.76).setInteractive({ pixelPerfect: true });
        ...
        // Small Brush
        const brushSmall = this.add.sprite(735, 240, 'brush_small', 'idle').setInteractive({ pixelPerfect: true });
        ...
        // Hoofpick
        const hoofpick = this.add.sprite(740, 184, 'feather_oil', 'idle').setInteractive( { pixelPerfect: true } )//.setScale(0.75);
        ...
        const featherOilUse = this.sound.add('feather_oil_use');
            ...
            const hoofpickText = this.add.text(685, 150, 'Static Text Object', hoverTextSettings).setAlpha(0);
            ...
            hoofpick.on('pointerover', function (pointer) { 
             ...
             hoofpick.on('pointerout', function (pointer) { pointeroutNew (hoofpick, hoofpickText)});
        ...
        const frame = this.add.image(164, 77, 'horse_image').setScale(.35).setInteractive();
        ...
        // const frameInteractive = this.add.graphics().setInteractive(new Phaser.Geom.Rectangle(478, 65, 75, 110), Phaser.Geom.Rectangle.Contains);
            ...
            frame.on('pointerout', function (pointer) { });
        ...
        // Water Fountain
        trough = this.add.sprite(200, 348, 'fountain', 'idle').setInteractive({ pixelPerfect: true });
...
function pointerout(sprite) {
    if (handCurrent === HAND.empty) {
        ...
        appleMunch = this.sound.add('apple_munch');
            this.anims.create({
                ...
                frames: this.anims.generateFrameNumbers('berries', { frames: [
                    'pickup0000', 'pickup0001', 'pickup0002', 'pickup0003', 'pickup0004', 'pickup0005', 'pickup0006', 'pickup0007', 'pickup0008'
                ] }),
                frameRate: 24
            });
        ...
        const leafTree = this.add.sprite(560, 480, 'leaf_tree_shake', 'idle');
        ...
        const gotoWorldBg = this.add.image(770, 108, 'goworld_box').setAlpha(0.01).setOrigin(.5).setInteractive()
        const gotoWorldTxt = this.add.text(770, 108, 'Static Text Object', hoverTextSettingsSmall).setAlpha(0).setOrigin(.5, .5);
